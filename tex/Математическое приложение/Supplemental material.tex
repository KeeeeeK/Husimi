...
\end{eqw}
где $\hat{B}_{2n, j}\left(a_1, a_2, \dots, a_{2n-j+1}\right)$ --- экспоненциальные полиномы Белла от коэффициентов в разложении  $f$ по ряду Тейлора \ref{f taylor}. 
...
\end{eqw}
Применим эти формулы для полиномов Белла, встречающихся в \ref{asymptotic gamma_k int raw}:
\begin{eqw}
