...
\block{Basic idea}
{
    ...
    \begin{eqw}
        ...
        \frac{1}{\sqrt{2\abs{A\Gamma}}}\left(1-\frac{1}{\left(4\abs{A\Gamma}\right)^2} + \frac{5/2}{\left(4\abs{A\Gamma}\right)^4}+\dots\right)
        \exp\left(\abs{A} - \frac{\left(\arg\left( Ae^{iR\sign\Gamma}\right) - \Gamma\right)^2}{8|A\Gamma^2|}+\dots\right),
    \end{eqw}
    pic with dependence
}
\block{Scheme}
{
    \begin{center}
        \include{tikz_pic/straight_pic.tex}
    \end{center}
}
\end{columns}
