...
\begin{enumerate}
    ...
    \item Большая буква $Z$ обозначает неизменную комплексную величину\footnote{Надеюсь на благоразумность читателей, потому что автор против Z-движения в России}
\end{enumerate}
