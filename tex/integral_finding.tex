...
\begin{equation}
\begin{aligned}
    \Real\left((z_k+i)^2\right) = \Real(z_k)^2 - \left(\Imag(z_k)+1\right)^2 = \Imag(W_k(Z))^2 - \left(\Real(W_k(Z))+1\right)^2
\end{aligned}
\end{equation}
...
\begin{aligned}
    ...
    &\left(\Phi + 2\pi k -\frac{\pi}{2}\sign k + O\left(\frac{\log R}{k}\right)\right)\left(2\pi + O\left(\frac{\log^2 R}{k^2}\right)\right) = \\
    &= \left(\log R + 1 - \log\left(2\pi |k|\right)+O\left(\frac{\log^2 R}{k^2}\right)\right)\frac{-1}{k}\left( 1+ O\left(\frac{\log^2 R}{k^2}\right)\right)\\
    &\left(2\pi k + \Phi -\frac{\pi}{2}\sign k\right)2\pi k \approx \log R + 1 - \log\left(2\pi |k|\right)
\end{aligned}
\end{equation}
\end{document}