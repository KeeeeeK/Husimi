...
\begin{aligned}
    ...
    &= \frac{(-2iz e^{2iz_k})^j (2i)^{2n}j!}{(2n)!}B_{2n, j}\left( \frac{1}{2\cdot 3}, \frac{1}{3\cdot 4} , \dots, \frac{(2n-j+1)!}{(2n-j+3)!}\right)
\end{aligned}
\end{equation}
...
\begin{aligned}
    ...
    &= \exp\left(\frac{u}{t^2}\left(e^t - 1 -t - \frac{t^2}{2}\right)\right) \\
    &= \sum\limits_{n=2k, k = 0}^{\infty} S_{3}(n, k) \frac{u^k}{t^{2k}}\frac{t^n}{n!} \\
    &= \sum\limits_{n=2k, k = 0}^{\infty} S_{3}(n+2k, k) u^k\frac{t^n}{(n+2k)!} \\
    &= \sum\limits_{n, k = 0}^{\infty} \frac{k!}{(k+2n)!}S_{3}(k+2n, n) u^n\frac{t^k}{k!}
\end{aligned}
\end{equation}
...
\begin{equation}
\begin{aligned}
    \hat{B}_{n, k}\left(\frac{1}{3!}, \frac{1}{4!}, \dots, \frac{1}{(n-k+3)!}\right) = \frac{k!}{(k+2n)!}S_{3}(k+2n, n)
\end{aligned}
\end{equation}
\end{document}