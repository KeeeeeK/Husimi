...
\begin{equation}
\begin{aligned}
    &\frac{\pi^2\sign k}{R} - \frac{\sign k }{R}
    \left((\varkappa + 2\pi\sign k)\left(\Phi + \frac{\varkappa + 2\pi\sign k}{2}\right) - 
    \varkappa \left(\Phi + \frac{\varkappa}{2}\right)\right) = O\left(\frac{\log^2 R}{R^2}\right)\\
