...
\begin{aligned}
    \int_{\gamma} e^{\lambda f(z)} dz = 2e^{\lambda f(z_0)}\sum\limits_{n=0}^{\infty} \Gamma\left(n+\frac{1}{2}\right)\frac{c_{2n}}{\lambda^{n+\frac{1}{2}}} \\
    c_{2n} = \frac{1}{2(2n)!}\left[\left(\frac{d}{dz}\right)^{2n}\left\lbrace\frac{(z-z_0)^2}{f(z)-f(z_0)}\right\rbrace^{n+\frac{1}{2}}\right]_{z=z_0}
\end{aligned}
\end{equation*}
...
\begin{aligned}
    ...
    &=  \underbrace{\left(-2i - 2iz e^{2iz_k}\right)}_{a_0} - \sum\limits_{p=1}^{\infty} \underbrace{\frac{(2i)^{p+1}ze^{2iz_k}}{(p+2)!}}_{a_1, a_2, \dots}(x-z_k)^{p}
\end{aligned}
\end{equation}
